...
public class OrbitCamera : MonoBehaviour
{
    ...
    Vector2 orbitAngles = new Vector2(45, 0f);
    ...
    #region Input IDs
    private const string RotateVertically = "Mouse Y";
    private const string RotateHorizontally = "Mouse X";
    #endregion Input IDs

    // A validation check for limiting the maxVerticalAngle so its value will never lower than minVerticalAngle.
    ...
    // for visualizing the focus radius
    private void OnDrawGizmos()
    {
        Gizmos.color = Color.blue;
        Gizmos.DrawWireSphere(focusPoint, focusRadius);
    }
    ...
    {
        Vector2 input = new Vector2(-Input.GetAxis(RotateVertically), Input.GetAxis(RotateHorizontally));
